            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="w-3/4 m-auto text-base sm:text-lg text-gray-600 mt-6">
                        Discover our most popular and best-selling products that customers love.
                        These items have been carefully selected based on customer satisfaction and quality.
                    </p>
                </div>
